...
function OneChatItem({}: Props) {
  return (
    <div className='my-1'>
        <div className='flex cursor-pointer rounded-xl duration-200 bg-[#fff0] gap-4 dark:hover:bg-[#1b1b1b] hover:bg-[#f5f5f5] items-center justify-start h-auto px-4 p-2 w-full '>
