...
function OneChatItem({chat}: Props) {
  return (
    <div className='my-1'>
        <div className='flex cursor-pointer rounded-xl duration-200 bg-[#fff0] gap-4 dark:hover:bg-[#1b1b1b] hover:bg-[#f5f5f5] items-end justify-start h-auto px-3 p-2 w-full '>
            ...
            <div className='flex items-start flex-col flex-1'>
                ...
                <h3 className='text-sm'>{chat.lastMessage}</h3>
            </div>
